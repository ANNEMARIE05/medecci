    ...
    <div className="min-h-screen bg-neutral-950 flex flex-col">
      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 p-4 md:p-8 md:ml-64 flex flex-col items-center">
          <div className="bg-neutral-900 rounded-2xl p-8 md:p-12 shadow-lg w-full max-w-3xl">
            {/* Profil résumé */}
            <div className="flex flex-col sm:flex-row items-center gap-6 mb-8">
              ...
              <div className="flex-1 flex flex-col gap-3 items-center sm:items-start">
                <div className="flex items-center gap-2">
                  <span className="bg-orange-100 text-orange-700 px-3 py-1 rounded-full text-xs font-bold">{user.plan.split(' ')[0]} Mensuel</span>
                  <span className="text-neutral-400 text-xs">Membre depuis {user.membreDepuis}</span>
                </div>
                <Button size="sm" className="bg-orange-500 hover:bg-orange-600 text-white font-semibold mt-2" onClick={() => setEdit(true)}>
                  <Edit2 size={16} className="mr-2" /> Modifier
                </Button>
              </div>
            </div>
            {/* Formulaire d'édition */}
            <form onSubmit={handleSave} className="space-y-6 bg-neutral-900 rounded-xl p-6">
              ...
              {erreur && <div className="text-red-500 text-center font-semibold mt-2">{erreur}</div>}
              {edit && (
