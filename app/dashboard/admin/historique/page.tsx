          ...
          <div className="w-full max-w-4xl">
            ...
            <div className="hidden lg:block overflow-x-auto">
              <table className="min-w-full border border-gray-200 rounded-lg">
                ...
                <tbody>
                  {produits.length === 0 ? (
                    <tr><td colSpan={7} className="text-center py-8 text-gray-400">Aucun ajout pour le moment.</td></tr>
                    ...
                    <tr key={idx} className="border-b">
                      ...
                      <td className="px-3 py-2 text-gray-400 text-xs">
                        {editIndex === idx ? (
                          <span className="italic text-gray-400">(date non modifiable)</span>
                        ) : (
            ...
            <div className="grid grid-cols-1 gap-4 lg:hidden">
              {produits.length === 0 ? (
                <div className="text-center py-8 text-gray-400">Aucun ajout pour le moment.</div>
              ) : produits.map((produit, idx) => (
                  ...
                  <div className="flex gap-4 items-center">
                    ...
                    <div className="flex-1">
                      <div className="font-bold text-blue-900 text-lg mb-1">
                        {editIndex === idx ? (
                          <input type="text" name="nom" value={editForm.nom} onChange={handleEditChange} className="border rounded px-2 py-1 w-full" />
                        ) : (
                          produit.nom
                        )}
                      </div>
                      <div className="text-xs text-gray-700 mb-1">
                        {editIndex === idx ? (
                          <textarea name="description" value={editForm.description} onChange={handleEditChange} className="border rounded px-2 py-1 w-full text-xs" rows={2} />
                        ) : (
                          produit.description
                        )}
                      </div>
                      ...
                      <div className="text-gray-700 text-xs mb-1">
                        {editIndex === idx ? (
                          <input type="tel" name="whatsapp" value={editForm.whatsapp} onChange={handleEditChange} className="border rounded px-2 py-1 w-full" />
                        ) : (
                          produit.whatsapp
                        )}
                      </div>
